...
with st.sidebar:
    st.markdown("""
    # About 
    Pitch Analyzer is a helper tool built on [LangChain](https://langchain.com) and [CAMEL](https://github.com/lightaime/camel) 
    to review the pitch of projects/startups to train founders and prepare for the questions they receive from investors and stakeholders.
    """)
    st.markdown(html_temp.format("rgba(55, 53, 47, 0.16)"),unsafe_allow_html=True)
    st.markdown("""
    # How does it work
    Simply upload the text of your pitch. [Here you have samples](https://github.com/Dabhadevivek/PitchWiz-)
    *Due to resource issues, this initial version (alpha) generates each text every 21 seconds.*
    """)
    st.markdown(html_temp.format("rgba(55, 53, 47, 0.16)"),unsafe_allow_html=True)
    st.markdown("""
    Made by [VIVEK DABHADE](https://www.linkedin.com/in/vivek-dabhade-5a961b260/)
    """,
...
st.markdown("""
#### Enter all your pitch text and you will see the possible questions you would receive from investors
# and stakeholders, while an agent will try to answer from your pitch text, and if there is no information, infer an answer or not answer, so you can prepare for future events to present your startup.
""")
